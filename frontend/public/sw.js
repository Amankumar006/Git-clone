// Service Worker for Medium Clone
// Provides offline functionality and caching

const CACHE_NAME = 'medium-clone-v1';
...
const STATIC_ASSETS = [
  '/',
  '/manifest.json',
  // Add other critical assets that actually exist
];
...
async function handleStaticAsset(request) {
  // Skip caching requests from chrome-extension or other unsupported schemes
...
async function handlePageRequest(request) {
  try {
    ...
    return caches.match('/offline.html') || new Response(
      ...
      <html>
        <head>
          <title>Offline - Medium Clone</title>
...
async function handleBackgroundSync() {
  ...
  // You can implement queued actions here
  // For example: sync offline comments, claps, bookmarks
}
